...
<!-- /header -->
    ...
    <h1 class="h3 mb-3">LISTE DES REGIONS</h1>
                ...
                <div class="card-body">
							...
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Liste des regions</h5>
								</div>
								<table class="table table-hover my-0">
									<thead>
										<tr>
											<th>Id</th>
											<th class="d-none d-xl-table-cell">Nom Region</th>
...
<script>
    const getAllCitoyens = async () =>{
            var res  =  await fetch("http://localhost:5000/api/regions");
            var result = await res.json();
            console.log("valeur de result:",result.regions);
            ...
            result.regions.map(
                (result)=>{
                    ...
                    var id = result.id;
                    var code_region = result.code_region;
                    var intitule = result.intitule;
                    ...
                    tsr+="<tr>";
						tsr+="<td>"+id+"</td>";
                        tsr+="<td class='d-none d-xl-table-cell'>"+intitule+"</td>";
                        //tsr+="<td class='d-none d-xl-table-cell'>"+created_at+"</td>";
                        tsr+="<td>";
